  ...
  return (
    <div className="side-bar-body">
      ...
      >
        ...
        <div className="side-bar-text">scripts</div>
      </div>
      ...
      >
        ...
        <div className="side-bar-text">board</div>
      </div>
      {/* <div
        className={`${
      ...
      >
        ...
        <div className="side-bar-text">schedule</div>
      </div>
      ...
      >
        ...
        <div className="side-bar-text">message</div>
      </div>
      ...
      >
        ...
        <div className="side-bar-text">team</div>
      </div>
    </div>
  );
}
